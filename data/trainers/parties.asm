...
RedGroup:
	...
	db 83, ESPEON,     MUD_SLAP, REFLECT, SWIFT, PSYCHIC_M
...
HibikiGroup:
	; HIBKI (1)
	db "HIBIKI@", TRAINERTYPE_ITEM_MOVES
	db 91, JOLTEON,   LEFTOVERS, DOUBLE_TEAM, BATON_PASS, THUNDERBOLT, HIDDEN_POWER
	db 91, AZUMARILL, BRIGHTPOWDER, PERISH_SONG, PROTECT, WHIRLPOOL, DYNAMICPUNCH
	db 91, GENGAR,    PINK_BOW, DYNAMICPUNCH, THUNDERPUNCH, ICE_PUNCH, EXPLOSION
	db 91, URSARING,  QUICK_CLAW, CURSE, REST, EARTHQUAKE, MEGA_PUNCH
	db 91, MACHAMP,   BLACKBELT, DYNAMICPUNCH, EARTHQUAKE, FIRE_PUNCH, ICE_PUNCH
	db 91, DRAGONITE, SCOPE_LENS, OUTRAGE, ICE_PUNCH, THUNDERPUNCH, FIRE_PUNCH	
	db -1 ; end