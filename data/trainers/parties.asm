...
HibikiGroup:
	; HIBKI (1)
	db "HIBIKI@", TRAINERTYPE_MOVES
	db 100, LEDIAN,    REFLECT, BATON_PASS, DOUBLE_TEAM, LIGHT_SCREEN
	db 100, AZUMARILL, PERISH_SONG, PROTECT, REST, DYNAMICPUNCH
	db 100, GENGAR,    THUNDERPUNCH, ICE_PUNCH, FIRE_PUNCH, EXPLOSION
	db 100, URSARING,  CURSE, REST, EARTHQUAKE, MEGA_PUNCH
	db 100, MACHAMP,   DYNAMICPUNCH, EARTHQUAKE, FIRE_PUNCH, ICE_PUNCH
	db 100, DRAGONITE, OUTRAGE, ICE_PUNCH, THUNDERPUNCH, FIRE_PUNCH	
	db -1 ; end