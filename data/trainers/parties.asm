...
HibikiGroup:
	...
	db 50, LEDIAN,    REFLECT, BATON_PASS, DOUBLE_TEAM, COMET_PUNCH
	db 50, GENGAR,    THUNDERPUNCH, ICE_PUNCH, FIRE_PUNCH, EXPLOSION
	db 50, URSARING,  CURSE, REST, SHADOW_BALL, MEGA_PUNCH
	db 50, MACHAMP,   CROSS_CHOP, EARTHQUAKE, FIRE_PUNCH, REST
	db 50, DRAGONITE, OUTRAGE, ICE_PUNCH, THUNDERPUNCH, FIRE_PUNCH
	db -1 ; end